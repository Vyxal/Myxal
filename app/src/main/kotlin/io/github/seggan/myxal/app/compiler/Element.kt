...
enum class Element {
    ...
    val text: String
    private val compileMethod: (ClassWriter, MyxalMethod) -> Unit

    constructor(text: String, compileMethod: (MyxalMethod) -> Unit) : this(
        text,
        { _, mv -> compileMethod(mv) }
    )

    constructor(text: String, compileMethod: (ClassWriter, MyxalMethod) -> Unit) {
        this.text = text
            ...
            if (vectorise && CompilerOptions.doesNotContain(CompilerOptions.DONT_VECTORISE_MONADS)) {
                ...
                mv.visitLdcInsn(
                    Handle(
                        ...
                        "io/github/seggan/myxal/runtime/RuntimeMethods",
                        methodName,
    ...
    fun compile(cw: ClassWriter, mv: MyxalMethod) {
        compileMethod(cw, mv)
    }
