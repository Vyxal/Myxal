...
import io.github.seggan.myxal.antlr.MyxalParser.AliasContext
import io.github.seggan.myxal.antlr.MyxalParser.CONTEXT_VAR
import io.github.seggan.myxal.antlr.MyxalParser.Complex_numberContext
import io.github.seggan.myxal.antlr.MyxalParser.ConstantContext
import io.github.seggan.myxal.antlr.MyxalParser.ElementContext
import io.github.seggan.myxal.antlr.MyxalParser.For_loopContext
import io.github.seggan.myxal.antlr.MyxalParser.Fori_loopContext
import io.github.seggan.myxal.antlr.MyxalParser.If_statementContext
import io.github.seggan.myxal.antlr.MyxalParser.IntegerContext
import io.github.seggan.myxal.antlr.MyxalParser.LambdaContext
import io.github.seggan.myxal.antlr.MyxalParser.ListContext
import io.github.seggan.myxal.antlr.MyxalParser.LiteralContext
import io.github.seggan.myxal.antlr.MyxalParser.One_element_lambdaContext
import io.github.seggan.myxal.antlr.MyxalParser.ProgramContext
import io.github.seggan.myxal.antlr.MyxalParser.Program_nodeContext
import io.github.seggan.myxal.antlr.MyxalParser.StringContext
import io.github.seggan.myxal.antlr.MyxalParser.Three_element_lambdaContext
import io.github.seggan.myxal.antlr.MyxalParser.Two_element_lambdaContext
import io.github.seggan.myxal.antlr.MyxalParser.Variable_assnContext
import io.github.seggan.myxal.antlr.MyxalParser.While_loopContext
import io.github.seggan.myxal.antlr.MyxalParserBaseVisitor
import io.github.seggan.myxal.app.CompilerOptions
import io.github.seggan.myxal.app.compiler.wrappers.MyxalClassWriter
...
class Compiler private constructor(private val classWriter: MyxalClassWriter, private val clinit: MethodVisitor) :
    MyxalParserBaseVisitor<Unit>(), Opcodes {

    private val variables: MutableSet<String> = HashSet()
    private val contextVariables: MutableSet<String> = HashSet()

    private val callStack: Deque<MyxalMethod> = ArrayDeque()
    ...
    private fun visitModifier(modifier: String): Consumer<MyxalMethod>? {
        val mv = callStack.peek()
        // ß
        if ("ß" == modifier) {
            val end = Label()
            ...
            mv.visitJumpInsn(Opcodes.IFEQ, end)
            return Consumer { m: MyxalMethod -> m.visitLabel(end) }
        } else if ("&" == modifier) {
            mv.loadStack()
            mv.visitFieldInsn(
                Opcodes.GETSTATIC,
    ...
    companion object {
        ...
        fun compile(parser: MyxalParser, fileName: String?): ByteArray {
            val cw = MyxalClassWriter(ClassWriter.COMPUTE_FRAMES)
